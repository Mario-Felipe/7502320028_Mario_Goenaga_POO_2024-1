...
public class Principal {
    ...
    public static void main(String args[]) {
        ...
        actividadUno.setDescripcion("T1.ProyectoA");
        ...
        actividadDos.setDescripcion("T1.ProyectoB");
 ...
 ;       } catch (Exception e){
         ...
         try {
            ...
            tareaCrud.buscar("T1.ProyectoA");
            tareaCrud.buscar("T1.ProyectoB");
            tareaCrud.buscar("T1.ProyectoXXX");
            tareaCrud.editar(actividadUno);
            tareaCrud.editar(actividadDos);       
            tareaCrud.eliminar("T1.ProyectoA");
         ...
         /* Preguntar CRUD clase tarea, la key usada es descripción
          *  quice cambiarlo pero no hay otro atributo que sea un 
          *  identificador como tal.. Hice un cambio, pero igual pregunta
          */
